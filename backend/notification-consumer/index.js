...
async function startConsumer() {
    try {
        ...
        console.log(`[*] Notification Consumer aguardando mensagens na fila: ${q.queue}`);
        ...
        channel.consume(q.queue, (msg) => {
            if (msg.content) {
                ...
                console.log(
                    `[x] Notification Service: Enviando comprovante da lista [${messageContent.listId}] para o usuário [${messageContent.userEmail}]`
                );
        ...
        console.error('Erro no Notification Consumer:', error.message);
